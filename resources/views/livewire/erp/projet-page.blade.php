            ...
            <div class="card">
                <div class="card-header">
                    <ul class="nav nav-tabs card-header-tabs" data-bs-toggle="tabs">
                        <li class="nav-item">
                            <a href="#tabs-resume" class="nav-link " data-bs-toggle="tab">
                                <i class="ti ti-home"></i> Résumé
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="#tabs-devis" class="nav-link active" data-bs-toggle="tab">
                ...
                <div class="card-body">
                    <div class="tab-content">
                        <div class="tab-pane " id="tabs-resume">
                            @component('components.erp.projet.projet-resume',['projet'=>$projet])

                            @endcomponent
                        </div>

                        <div class="tab-pane active show" id="tabs-devis">
