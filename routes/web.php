...
use App\Http\Livewire\Tabler\Admin\Config;
...
Route::middleware(['auth'])->group(
    ...
    Route::get('/tabler/admin/config', Config::class)->name('tabler.admin.config');
    Route::get('/tabler/admin/config', AdminIndex::class)->name('tabler.admin.admin');
