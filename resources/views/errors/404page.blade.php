        ...
        <div class="page-wrapper">
            ...
            <div class="text-center mt-5">
                ...
                <div class="rounded mx-auto d-block">
                    <img src="{{ asset("img/icons/not-found.png") }}" alt="Image">
                </div>

                <div class="fw-bold fs-1">Oops Vous etes tombés sur une page d'erreur</div>

                <a href="{{ url()->previous() }}" class="btn btn-primary me-2 mt-3">  <i class="ti ti-arrow-left"></i> Retour</a>
            </div>
