...
<div class="col-md-8 mb-3">
    ...
    <input type="text" class="form-control" wire:model="transaction_form.montant" placeholder="Nom">
    @error('transaction_form.montant') <span class='text-danger'>{{ $message }}</span> @enderror
</div>

<div class="col-md-4 mb-3">
    <label class="form-label">Type</label>
    <select class="form-control" wire:model="transaction_form.type">
...
<div class="col-md-8 mb-3">
    ...
    <input type="text" class="form-control" wire:model="transaction_form.date" placeholder="Nom">
