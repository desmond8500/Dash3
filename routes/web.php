...
use App\Livewire\Erp\InvoiceResumePage;
...
Route::middleware(['auth', 'can:erp'])->group(function () {
    ...
    Route::get('/invoice_resume', InvoiceResumePage::class)->name('invoice_resume');
    ...
    Route::get('/facture/proposal_pdf/{proposal_id}/{type}', function ($proposal_id, $type) { return PDF2Controller::proposal_pdf($proposal_id, $type); })->name('proposal_pdf');
