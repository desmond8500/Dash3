    ...
    <div class="row g-2">
        ...
        <div class="col-auto text-primary">
            <div class="text-center border border-info rounded p-1" style="width: 70px">
                ...
                <div class="fw-bold" style="font-size: 17px">{{ $date->format('Y')}}</div>
            </div>
        </div>
        <div class="col">
            <div class="row">
                <div class="col">
                    <div class="text-primary fw-bold mt-1 text-center border-bottom pb-1">
                        {{ strtoupper($journal->type) ?? "Rapport d'intervention" }}
                    </div>
                </div>
                <div class="col-auto">
                    <div class="dropdown">
